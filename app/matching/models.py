...
class Utilisateurs(models.Model):
    ...
    centre_interet = models.TextField(db_column='Centre_interet', blank=True, null=True)
...
class Matching(models.Model):
    ...
    mentor = models.ForeignKey(
        ...
        on_delete=models.CASCADE,
        db_column='mentor_id',
        related_name='matching_mentor'
    )
    mentore = models.ForeignKey(
        Utilisateurs,
        on_delete=models.CASCADE,
        db_column='mentore_id',
        related_name='matching_mentore'
    )
...
class Messages(models.Model):
    ...
    conversations = models.ForeignKey(
        Conversations,
        on_delete=models.CASCADE,
        db_column='conversations_id'
    )
    expediteur = models.ForeignKey(
        Utilisateurs,
        on_delete=models.CASCADE,
        db_column='expediteur_id'
    )
